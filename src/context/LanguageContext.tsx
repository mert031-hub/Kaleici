...
const translations = {
  en: {
    ...
    gallery: {
      ...
      facade: 'Hotel Facade',
      bougainvillea: 'Bougainvillea Walk',
      lounge: 'Pool Lounge',
      breakfast: 'Breakfast Garden',
      courtyard: 'Stone Courtyard',
      evening: 'Evening Garden',
      poolside: 'Pool Side',
      floral: 'Floral Alley',
      room: 'Guest Room',
    ...
    accommodation: {
      ...
      cta1: 'Book Your Stay',
      cta2: 'Call Us',
      noFees: 'No booking fees. Direct reservation only. Best rates guaranteed.',
    },
    amenities: {
      ...
      breakfastDesc: 'Freshly prepared Turkish breakfast served in our garden every morning',
      poolTitle: 'Outdoor Pool',
      poolDesc: 'Refreshing outdoor swimming pool perfect for sunny Antalya days',
      acTitle: 'Air Conditioning',
      acDesc: 'Individual climate control in every room for your comfort',
      gardenTitle: 'Garden Area',
      gardenDesc: 'Lush Mediterranean garden with lounging areas and morning breakfast spot',
      locationTitle: 'Central Location',
      locationDesc: "Walking distance to Hadrian's Gate, Mermerli Beach & historic streets",
      checkinTitle: 'Check-in 14:00',
      checkinDesc: 'Flexible check-in from 2:00 PM. Early check-in subject to availability',
      checkoutTitle: 'Check-out 11:00',
      checkoutDesc: 'Check-out by 11:00 AM. Late check-out available upon request',
    ...
    contact: {
      ...
      whatsapp: 'WhatsApp',
      whatsappDesc: 'Chat with us instantly. We typically respond within minutes.',
      phone: 'Phone Call',
  ...
  tr: {
    ...
    gallery: {
      ...
      garden: 'Bahçe Terası',
      facade: 'Otel Cephesi',
      bougainvillea: 'Begonvil Yolu',
      lounge: 'Havuz Kenarı',
      breakfast: 'Kahvaltı Bahçesi',
      courtyard: 'Taş Avlu',
      evening: 'Akşam Bahçesi',
      poolside: 'Havuz Yanı',
      floral: 'Çiçek Koridoru',
      room: 'Misafir Odası',
      rooftop: 'Çatı Manzarası',
    },
    accommodation: {
      badge: 'Konaklamanız',
      title1: 'Mükemmel',
      ...
      cta2: 'Bizi Arayın',
      noFees: 'Rezervasyon ücreti yok. Yalnızca direkt rezervasyon. En iyi fiyat garantisi.',
    },
    amenities: {
      ...
      gardenDesc: 'Dinlenme alanları ve sabah kahvaltı noktasıyla yemyeşil Akdeniz bahçesi',
      locationTitle: 'Merkezi Konum',
      locationDesc: 'Hadrian Kapısı, Mermerli Plajı ve tarihi sokaklara yürüme mesafesinde',
      checkinTitle: 'Giriş 14:00',
      checkinDesc: "Öğleden sonra 14:00'ten itibaren giriş. Erken giriş müsaitliğe göre",
    ...
    contact: {
      ...
      whatsapp: 'WhatsApp',
      whatsappDesc: 'Anında mesaj gönderin. Genellikle dakikalar içinde yanıt veriyoruz.',
      phone: 'Telefon',
