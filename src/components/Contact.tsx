      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="font-inter text-base text-gray-500 max-w-xl mx-auto">
            No online forms, no booking fees. Simply reach out directly and
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-10">
            ...
            <AnimIn delay={0.1}>
              ...
              >
                ...
                <h3 className="font-playfair text-2xl font-bold text-white mb-2">WhatsApp</h3>
                <p className="font-inter text-sm text-white/85 mb-4 leading-relaxed">
            ...
            <AnimIn delay={0.2}>
              ...
              >
                ...
                <h3 className="font-playfair text-2xl font-bold text-white mb-2">Phone Call</h3>
                <p className="font-inter text-sm text-white/85 mb-4 leading-relaxed">
                  Speak directly with our team. Available every day.
                </p>
                <span className="font-inter text-sm font-semibold text-white bg-white/20 px-4 py-2 rounded-full">
                  +90 543 148 07 00
                </span>
          ...
          <AnimIn delay={0.3}>
            <div className="grid sm:grid-cols-3 gap-4">
              ...
              <div className="flex items-center gap-3 bg-stone-50 rounded-2xl p-4 border border-stone-200">
                ...
                <div>
                  <p className="font-inter text-xs text-gray-500 font-medium">Check-in</p>
                  <p className="font-inter font-semibold text-gray-800">From 14:00</p>
                </div>
              </div>
              {/* Check-out */}
              <div className="flex items-center gap-3 bg-stone-50 rounded-2xl p-4 border border-stone-200">
                ...
                <div>
                  <p className="font-inter text-xs text-gray-500 font-medium">Check-out</p>
                  <p className="font-inter font-semibold text-gray-800">By 11:00</p>
                </div>
              </div>
              {/* Instagram */}
              <a
              ...
              >
                ...
                <div>
                  <p className="font-inter text-xs text-gray-500 font-medium">Instagram</p>
