...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <svg
        className="absolute top-1/4 left-8 opacity-15 text-white pointer-events-none"
        width="80"
        height="120"
        viewBox="0 0 80 120"
        fill="none"
      >
        <path
          d="M40 120 C40 120 5 80 5 45 C5 20 20 5 40 5 C60 5 75 20 75 45 C75 80 40 120 40 120Z"
          fill="white"
        />
      </svg>
      <svg
        className="absolute bottom-32 right-12 opacity-15 text-white pointer-events-none rotate-45"
        width="60"
        height="90"
        viewBox="0 0 80 120"
        fill="none"
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {mounted && (
          ...
          >
            ...
            <span>3-Star Boutique Hotel · Antalya Kaleiçi</span>
          </motion.div>
        )}
        ...
        {mounted && (
          ...
          >
            Stay in the Heart
            <br />
            <span className="text-yellow-200">of Antalya Kaleiçi</span>
          </motion.h1>
        )}
        ...
        {mounted && (
          ...
          >
            A peaceful boutique hotel surrounded by gardens, history, and
            Mediterranean charm.
          </motion.p>
        )}
        ...
        {mounted && (
          ...
          >
            <div className="flex items-center gap-1.5 bg-white/15 backdrop-blur-sm border border-white/25 text-white px-4 py-2 rounded-full text-sm font-inter">
              <span className="text-yellow-300 text-base">★★★★★</span>
              <span className="font-semibold">4.5/5</span>
              <span className="text-white/75">· 875 Reviews</span>
            </div>
            <div className="flex items-center gap-1.5 bg-white/15 backdrop-blur-sm border border-white/25 text-white px-4 py-2 rounded-full text-sm font-inter">
              <svg className="w-4 h-4 text-yellow-200" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
              </svg>
              <span>Prime Kaleiçi Location</span>
            </div>
            <div className="flex items-center gap-1.5 bg-white/15 backdrop-blur-sm border border-white/25 text-white px-4 py-2 rounded-full text-sm font-inter">
              <svg className="w-4 h-4 text-yellow-200" fill="currentColor" viewBox="0 0 20 20">
