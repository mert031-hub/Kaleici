...
export default function Footer() {
  ...
  const quickLinks = [
    ...
    { label: nav.accommodation, href: '#accommodation' },
    { label: nav.amenities, href: '#amenities' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            <a href="#" className="inline-block mb-4">
              <span className="font-playfair text-2xl font-bold text-white">Kaleiçi Hotel</span>
            </a>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/5 rounded-xl p-3 border border-white/10">
                <p className="font-inter text-xs text-primary-400 font-medium mb-0.5">{ft.checkInOut}</p>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
              <p className="font-inter text-xs text-primary-400 text-center sm:text-left">
                &copy; {new Date().getFullYear()} Kaleiçi Hotel. {ft.copyright}
              </p>
              <span className="hidden sm:block text-primary-700">·</span>
              <p className="font-inter text-xs text-primary-500 font-medium text-center">{ft.noFees}</p>
            </div>
